        ...
        <div class="max-w-5xl h-fit grid items-center lg:h-[50vh] mx-auto mt-3 p-4 bg-slate-900 md:bg-transparent bg-opacity-75">
            <div>
                <h3 class="py-2 text-redder font-medium md:text-lg">
                    Come, and Taste Greatness at Safari Restaurant
                </h3>
                ...
                <p class="py-1 lg:w-2/3 text-lighter text-sm lg:text-base">
                    Bring your family to dinner, and we will make it a memory.
                </p>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-4 p-4 items-center">
            <div class="md:col-span-1 flex flex-col gap-y-3">
                <div class="py-1">
                    ...
                    <a href="{{ route('locations') }}" class="py-1 text-red-400 hover:text-red-500 text-xs underline underline-offset-2">View on Map</a>
                </div>
            ...
            <div class="py-3">
                <img src="/images/sample-map-landscape.png" alt="" class="rounded-lg shadow-sm shadow-lime-300">
            </div>
        </div>
    </div>
</x-guest-layout>