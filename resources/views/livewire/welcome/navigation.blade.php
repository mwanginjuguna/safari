<div class="w-full border-b shadow-sm">
    <div class="sticky sm:top-0 w-full flex justify-between sm:max-w-6xl sm:mx-auto z-10 py-4">
        ...
        <div class="text-end flex flex-row sm:space-x-6">
            ...
            <div class="flex items-center space-x-2">
                ...
                <svg width="24px" height="24px" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--noto" preserveAspectRatio="xMidYMid meet" fill="#000000">
