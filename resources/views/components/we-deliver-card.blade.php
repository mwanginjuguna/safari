<div class="grid md:grid-cols-2">
    <div class="py-2 md:col-span-1">
        <h3 class="py-2 lg:py-4 text-lg lg:text-xl font-semibold text-redder">
            We Deliver
        </h3>

        <h4 class="py-2 text-2xl lg:text-3xl font-bold text-darkblue">
            From Our Kitchen to Your Doorstep
        </h4>

        <p class="py-1 italic text-redder font-medium">
            "Speedy Safari Deliveries"
        </p>

        <p class="py-1 text-darkblue text-sm lg:text-base">
            Safari's commitment to excellence extends beyond our restaurant walls—experience the joy of fast, reliable deliveries that not only bridge the distance but also bring the warmth of our kitchen directly to your family's dining room.
        </p>

        <div class="py-3 lg:py-5 grid grid-cols-2 gap-3">
            ...
            <a href="{{ route('about') }}" class="w-fit px-2 py-1 text-white bg-redder hover:bg-red-600 rounded-md hover:underline underline-offset-2">Order Now</a>
        </div>
        
    </div>
    
    <div class="py-2 md:col-span-1 grid place-items-center">
        <video src="/storage/videos/free-food-delivery-youtube-video-ad.mp4" alt="" class="rounded-md object-center object-cover" autoplay loop controls>
    </div>
</div>